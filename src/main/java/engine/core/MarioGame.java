...
public class MarioGame {
     ...
     */
    protected MarioEvent[] killEvents;

    //visualization
    protected JFrame window = null;
    protected MarioRender render = null;
    protected MarioAgent agent = null;
    ...
    protected int getDelay(int fps) {
        if (fps <= 0) {
            return 0;
        }
        return 1000 / fps;
    ...
    protected void setAgent(MarioAgent agent) {
        this.agent = agent;
